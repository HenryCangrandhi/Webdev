...
<head>
    ...
    <link rel="stylesheet" href="css/styleFeaturePage-5sbox.css">
...
<body>
    <header>
        ...
        <section id="content-fp">
            <div id="videoCards">
                <div id="videoCard1">
                    <div id="videoCardSquare" style="background-color: #DC0D17;"></div>
                    <div id="videoCardContent" >
                        <video id="VideoSensoryBox" controls>
                            <source src="video/Presentation Final.mp4" type="video/mp4">
                        </video>
                    </div>
        ...
        <section id="product-link">
            <div id="sensoryBoxProduct">
                <img src="img/image-cs1.png" alt="sensory box image">
            </div>
            <div id="product-link-content">
                <h2>5 Sensory Box</h2>
                <p>Learning kit yang menggabungkan berbagai elemen pembelajaran 
